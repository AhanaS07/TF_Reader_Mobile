// Owner: Reader (Ahana).
//
// Pure logic, unit-tested directly — no DOM, no bridge, just two conversion functions between this
// feature's ReaderPosition/ReaderTarget and Sync's Locator.

import { targetFromLocator, toLocator } from './readerProgressStore';
