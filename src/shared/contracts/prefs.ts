...
//
// Accessibility is NOT here — Accessibility (Hruthik) owns it and syncs it via
...
export interface SharedPrefs {
  ...
  // Sync bookkeeping — matches Karthik's synced-record base.
  // Resolved by LWW on updatedAt.
  updatedAt: number; // client wall-time ms
  synced: boolean;
}
